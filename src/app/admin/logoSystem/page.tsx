        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white shadow-lg rounded-xl p-6 mb-6">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              <div>
                <h1 className="text-3xl font-bold text-gray-800 mb-2">Company Slider Sections Management</h1>
                <p className="text-gray-600">Manage company slider images with headers and descriptions</p>
              </div>
          ...
          <div className="fixed inset-0 bg-black/50 z-50 flex justify-center items-center p-4">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
              <div className="p-6 border-b border-gray-200">
                ...
                <p className="text-gray-600">Add a new Company Slider section with custom header and description</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white shadow-lg rounded-xl p-6 mb-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="flex-1">
                <h1 className="text-2xl font-bold text-gray-800">{currentSection.header}</h1>
                <p className="text-gray-600">{currentSection.description || "Manage images for this section"}</p>
          ...
          <div className="fixed inset-0 bg-black/50 z-50 flex justify-center items-center p-4">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
              <div className="p-6 border-b border-gray-200">
                ...
                <p className="text-gray-600">Upload a new logo image to {currentSection.header}</p>
              </div>
          ...
          <div className="fixed inset-0 bg-black/50 z-50 flex justify-center items-center p-4">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
              <div className="p-6 border-b border-gray-200">
                ...
                <p className="text-gray-600">Update section header and description</p>
              </div>
