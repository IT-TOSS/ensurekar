          ...
          >
            <ul className="flex justify-start items-center gap-1 flex-wrap">
              ...
              <li>
                ...
                >
                  <CaretRight/>
                  <span className="hover:text-s2 duration-300"> Team </span>
                </Link>
              </li>
            ...
            <h1 className="display-3 pt-4">Team Details</h1>

            <p className="text-bodyText pt-6">
              Meet our dedicated team of experts committed to delivering
