...
import breadcrumb_img_19 from "../../../images/breadcrumb_img_19.png";
    ...
    <section className="stp-30 bg-softBg1 relative max-xxl:overflow-hidden">
        ...
        >
          ...
          >
            ...
            <h1 className="display-3 pt-4">FAQ</h1>

            <p className="text-bodyText pt-6">
              Discover seamless accounting and payroll processing services
              tailored to your business needs. Our expert team ensures accuracy,
            </p>
          </div>
          <div
